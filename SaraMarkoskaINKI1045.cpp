...
char tocniVtori[4]={'a', 'c', 'a', 'b'};
char tocniTreti[4][2]={{'a','b'},{'b','d'},{'d','e'},{'a','c'}};
...
int main() {
    ...
    do {
        ...
        time_t vreme;
        ss.open("Students.log", ios::app);
        ss << n << ". Vreme - " << asctime(localtime(&vreme)) << "; Ime - " << lice.ime << " Prezime - " << lice.prezime << " Indeks - INKI" << lice.indeks << "\n";
        n++;
        brojnaprasanje = 1;
        poeni = 0;
        j++;
